...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<div class="tpl-portlet-components" id="edi">
					...
					<div class="tpl-table-images">
						<div class="am-u-sm-12 am-u-md-6 am-u-lg-4">
							<div class="tpl-table-images-content">
								<input type="hidden" id="getid" value="${movie.id }"> 
								<div class="tpl-table-images-content-i-time">${movie.timePublish}</div>
								<div class="tpl-i-title">${movie.movieName}</div>
								<a href="javascript:;" class="tpl-table-images-content-i">
									
									<span class="tpl-table-images-content-i-shadow"></span> <img
									src="${movie.imagePath}" alt="${movie.movieName}">
								</a>
							...
							<div class="am-cf">
								...
								<div class="am-fr">
									<ul class="am-pagination tpl-pagination">
										<!--前一页的实现  -->
										<li class="am-active"><a href="javascript:void(0)" id="editll">«</a></li>
										...
										<li><a href="javascript:void(0)" id ="editmoviel">»</a></li>
									</ul>
								</div>
							</div>
							<hr>
	...
	$(function (){
		$("#editmoviel").click(function(){
			...
			$.post("increase.edit",function(data){
	...
	//减少页号
		...
		$("#editll").click(function(){
			...
			$.post("decrease.edit",function(data){
